...
class GroupForm(forms.ModelForm):
    class Meta:
        model = Group
        fields = ['group_name', 'semester','group_category', 'course_id', 'department_id', 'added_by', 'group_link', 'group_description', 'group_type', 'wapp_qr', 'wapp_logo']
    ...
    group_category = forms.ChoiceField(choices=Group.GROUP_CATEGORIES, widget=forms.Select(attrs={'class': 'form-control'}))
