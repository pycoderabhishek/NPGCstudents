...
class Group(models.Model):
    ...
    course_id = models.IntegerField()  # You can replace IntegerField with ForeignKey if there's a Course model
    department_id = models.IntegerField()  # Replace with ForeignKey if there's a Department model
